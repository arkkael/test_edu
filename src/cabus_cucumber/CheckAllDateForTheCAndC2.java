...
public class CheckAllDateForTheCAndC2 {
 ...
 /* @Before
  ...
  public void testCheckAllDateForTheCAndC() throws Exception {
    ...
    driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
	  ...
	  driver.findElement(By.id("IDToken1")).clear();
	   ...
	   @И ("^Пользователь выбирает меню карт$")
  	   public void cardsMenu() throws Exception {
    ...
    driver.findElement(By.xpath("//header[@id='header']/div/div[3]/em-main-menu/div/div/div/div/ul/li/div[2]/div/ul/li[7]/div/a/span")).click();
	   ...
	   public void chooseVariants() throws Exception {
    ...
    Thread.sleep(500);
	   ...
	   public void takeParms() throws Exception {
    ...
    System.out.println("name= " + name + " lastName= " + lastName + " midName= " + midName + " IIN=" + 
	 ...
	 //  System.out.println(parentId);
	  ...
	  // System.out.println(childId);
	   ...
	   public void takeParms2() throws Exception {
	   ...
	   System.out.println("Address: House= " + houseNum2 + " street= " + street2 + " flat= " + 
	   ...
	   public void compareParms() throws Exception{
	   System.out.println("name= " + name2 + " ");
	    ...
	    if( CheckAllDateForTheCAndC2.driver.toString().contains("null"))
		  {
		  ...
		  {
			  CheckAllDateForTheCAndC2.driver.quit();
		  }
